...
//ICP1 - Arduino pin 43 - ATmega2560 pin 47
//ICP3 - Arduino pin 42 - ATmega2569 pin 9
//ICP4 - Arduino pin 49 - ATmega2560 pin 35
//ICP5 - Arduino pin 48 - ATmega2560 pin 36
...
void setup() {
  ...
  */
  ...
  TIFR3 = (1 << ICF3);
  TCCR3A = 0;
  TCCR3B = (0 << ICNC3)|(1 << ICES3)|(0 << WGM33)|
           (0 << WGM32)|(1 << CS31)|(1 << CS30);
  TIMSK3 = (1 << ICIE3)|(0 << TOIE3);

  /* Timer 4 setup */
  TIFR4 = (1 << ICF4);
  TCCR4A = 0;
  TCCR4B = (0 << ICNC4)|(1 << ICES4)|(0 << WGM43)|
           (0 << WGM42)|(1 << CS41)|(1 << CS40);
  TIMSK4 = (1 << ICIE4)|(0 << TOIE4);

  /* Timer 5 setup */
  TIFR5 = (1 << ICF5);
  TCCR5A = 0;
  TCCR5B = (0 << ICNC5)|(1 << ICES5)|(0 << WGM53)|
           (0 << WGM52)|(1 << CS51)|(1 << CS50);
